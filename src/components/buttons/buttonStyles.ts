export const buttonStyles = {
  base: "h-10 px-3.5 py-2.5 bg-black rounded border-2 border-black inline-flex justify-center items-center gap-1 overflow-hidden transition-colors duration-200",
  shadow:
...
export const combinedButtonStyles = `${buttonStyles.base} ${buttonStyles.shadow} ${buttonStyles.states}`;
