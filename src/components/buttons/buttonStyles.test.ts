...
describe("buttonStyles", () => {
  it("has the correct base style", () => {
    expect(buttonStyles.base).toBe(
      "h-10 px-3.5 py-2.5 bg-primary-button rounded border-2 border-primary-button inline-flex justify-center items-center gap-1 overflow-hidden transition-colors duration-200"
    );
  });
