...
export const PixieDropdown: React.FC<PixieDropdownProps> = ({
  ...
  return (
    ...
    >
      ...
      <div className="w-full xs:w-[153px] self-stretch justify-start items-center gap-2 flex">
        <div
          id={inputId}
      ...
      {isOpen && !isLocked && (
        <ul
          ...
          className="absolute z-10 right-0 top-[42px] w-full xs:w-[153px] bg-white rounded-lg shadow-lg border border-tertiary-stroke max-h-60 overflow-auto p-0 m-0 list-none"
        >
