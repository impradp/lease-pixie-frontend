...
const PropertyExpensesCard: React.FC<PropertyExpensesCardProps> = ({
  sectionName,
  editingSection,
  onSectionEdit,
  onSectionClose,
  ...
  return (
    ...
    >
      <SectionHeader
        ...
        showInfo={true}
        infoContent="Property Expenses:  property expenses description."
      />
    </div>
  );
};

export default PropertyExpensesCard;
