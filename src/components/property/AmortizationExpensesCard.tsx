...
interface AmortizationExpensesCardProps {
  sectionName: string;
...
const AmortizationExpensesCard: React.FC<AmortizationExpensesCardProps> = ({
  sectionName,
  editingSection,
  onSectionEdit,
  onSectionClose,
  ...
  return (
    ...
    >
      <SectionHeader
        ...
        showInfo={true}
        infoContent="Amortization Expenses:  used to track and bill annually, to CAM, expenses spread over multiple years.  Tenant level participation of these expenses are possible via Tenant Dashboard."
      />
    </div>
  );
};

export default AmortizationExpensesCard;
