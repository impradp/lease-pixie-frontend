...
interface AmortizedExpensesCardProps {
  sectionName: string;
...
const AmortizedExpensesCard: React.FC<AmortizedExpensesCardProps> = ({
  sectionName,
  editingSection,
  onSectionEdit,
  onSectionClose,
  ...
  return (
    ...
    >
      <SectionHeader
        ...
        showInfo={true}
        infoContent="Amortized Expenses:  used to track and bill annually, to CAM, expenses spread over multiple years.  Tenant level participation of these expenses are possible via Tenant Dashboard."
      />
    </div>
  );
};

export default AmortizedExpensesCard;
