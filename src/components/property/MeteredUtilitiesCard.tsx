...
interface MeteredUtilitiesCardProps {
  sectionName: string;
...
const MeteredUtilitiesCard: React.FC<MeteredUtilitiesCardProps> = ({
  sectionName,
  editingSection,
  onSectionEdit,
  onSectionClose,
  ...
  return (
    ...
    >
      <SectionHeader
        ...
        showInfo={true}
        infoContent="Metered Utilities:  used to define a list of utilities for which meter readings are required.  Any utility based on % share of ($) expense should be tracked and set in the Special Allocation list."
      />
    </div>
  );
};

export default MeteredUtilitiesCard;
