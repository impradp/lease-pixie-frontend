...
interface RealEstateTaxesCardProps {
  sectionName: string;
...
const RealEstateTaxesCard: React.FC<RealEstateTaxesCardProps> = ({
  sectionName,
  editingSection,
  onSectionEdit,
  onSectionClose,
  ...
  return (
    ...
    >
      <SectionHeader
        ...
        showInfo={true}
        infoContent="Real Estate Taxes:  used to track annual property real estate tax obligations and initiate workflows to confirm payments are made."
      />
    </div>
  );
};

export default RealEstateTaxesCard;
